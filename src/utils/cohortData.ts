 ...
 *
 * The CSVs under src/data/cohorts/<parent>__<group>/ are still generated by
 * scripts/refresh-cohort-tableone.mjs and left in place; restoring the level is
 * putting these four entries back:
 *   advanced_resp__icu / advanced_resp__no_icu  (ICU / Non-ICU)
 *   vaso__icu / vaso__no_icu                    (ICU / Non-ICU)
 */
